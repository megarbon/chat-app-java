<%-- 
    Document   : Register
    Created on : 29 nov 2023, 12:17:06
    Author     : dawmi
--%>
...
<html lang="en">
  ...
  <body class="no-scroll">
    <header class="text-gray-600 body-font" style="z-index: 1000">
      <div
      ...
      >
        ...
        >
          <a class="mr-5 hover:text-gray-900" href="#">Inicio</a>
          <a class="mr-5 hover:text-gray-900" href="#">Chat</a>
          <a class="mr-5 hover:text-gray-900" href="#">Contacto</a>
        </nav>
      </div>
    </header>
    ...
    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
      ...
      <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        <form class="space-y-6" action="../ProcesarRegistroServlet" method="POST">
          <div>
            <label
              for="email"
