<%-- 
    Document   : index
    Created on : 13 dic 2023, 8:50:00
    Author     : dawmi
--%>
      ...
      <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div class="relative mx-auto max-w-4xl grid space-y-5 sm:space-y-10">
          ...
          <div class="text-center">
            <p
              class="text-xs font-semibold text-indigo-500 tracking-wide uppercase mb-3 dark:text-indigo-500">
              La Mejor Tienda de España!
            </p>
            <h1
              class="text-3xl text-gray-900 font-bold sm:text-5xl lg:text-6xl lg:leading-tight dark:text-gray-900">
              Las ultimas tendencias en
              <span class="text-purple-500">Sneaker Freaks</span>
            </h1>
          </div>
          <!-- End Title -->
          ...
          >
            <!-- Image 1 -->
            <div
              class="relative overflow-hidden rounded-lg aspect-w-4 aspect-h-3"
            >
              <img
            ...
            >
              <img
                src="https://images.unsplash.com/photo-1542674684-fba3fa06625b?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                alt="Samba"
                class="object-cover w-full h-full"
              />
            </div>
            ...
            >
              <img
                src="https://images.unsplash.com/photo-1621665421558-831f91fd0500?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                alt="Samba"
                class="object-cover w-full h-full"
              />
            </div>
          ...
          <!-- SVG Element -->
          <div
            class="hidden absolute top-2/4 start-0 transform -translate-y-2/4 -translate-x-40 md:hidden lg:block lg:-translate-x-80"
            aria-hidden="true"
          >
            <svg
              class="w-52 h-auto"
          ...
          <!-- SVG Element -->
          <div
            class="hidden absolute top-2/4 end-0 transform -translate-y-2/4 translate-x-40 md:hidden lg:block lg:translate-x-80"
            aria-hidden="true"
          >
            <svg
              class="w-72 h-auto"
